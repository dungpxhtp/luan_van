...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
                <a class="btn btn-sm btn-success btn-them" href="#">Thêm Nhân Viên</a>
        </div>
    </div>
    <div class="row">
...
<div class="modal update_topic" tabindex="-1" role="dialog">
            ...
            <form id="update_topic">
             ...
             <div class="row">
                 <div class="col-md-12">
                     ...
                     <div class="form-group">
                        <label>Email</label>
                        <input name="email" class="form-control" type="email" value="{{ old('fullname') }}" required readonly>


                     </div>
                     <div class="form-group">
                         <label>Số điện thoại</label>
                         <input name="phone" class="form-control" type="number" maxlength="11" value="{{ old('phone') }}" required>
    ...
    {{--  modal them   --}}
    <div class="modal insert" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
                 ...
                 <div class="row">
                     <div class="col-md-12">
                         ...
                         <div class="form-group">
                            ...
                            <input name="password" min="6" class="form-control" type="password" value="{{ old('password') }}" required>
                         </div>
                         <div class="form-group">
                             <label>Số điện thoại</label>
                             <input name="phone" class="form-control" type="number" maxlength="11" value="{{ old('phone') }}" required>
...
@section('script')
    <script>
        ...
        $(document).on('submit','#update_topic',function(event){
            ...
            let url = "{{ Route('admin.update_admin',':id') }}";
            url=url.replace(':id',id);
            $.ajax({
                url:url,
                type:"POST",
