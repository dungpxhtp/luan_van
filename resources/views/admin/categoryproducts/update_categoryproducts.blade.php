...
<nav aria-label="Page breadcrumb" class="my-3">
    <div class="container">
            <ol class="breadcrumb">
                <li class="breadcrumb-item breadcrumb-customer"><i class="fas fa-tachometer-alt"></i>Cập Nhật Loại {{ $getData->name }}</li>
...
<div class="container">
<form  action="{{ Route('post_update_categoryproducts',['id_categoryproducts'=>$getData->id]) }}" method="post" role="form" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
