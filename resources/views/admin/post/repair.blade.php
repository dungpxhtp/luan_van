...
<nav aria-label="Page breadcrumb">
    ...
    <div class="container">
        <form  action="{{ Route('post_update.post',['id'=>$post->id]) }}" method="post" role="form" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
           ...
           <div class="row">
               <div class="col-md-9 box effect1">
                   ...
                   <div class="form-group">
                           ...
                           <textarea id="my-editor" name="detail" class="form-control">{{ old('detail',$post->detail) }}</textarea>

                   </div>
                   <div class="form-group">
                           <label>Từ Khóa Meta Key</label>
                           <textarea name="metakey" class="form-control" rows="2" >{{ old('metakey',$post->metaKey) }}</textarea>

                   </div>
                   <div class="form-group">
                           <label>Từ Khóa Meta Desc</label>
                           <textarea name="metadesc" class="form-control" rows="2">{{ old('metakey',$post->metaDesc) }}</textarea>
                       ...
                       <div class="form-group ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="thumbnail" class="form-control" type="text" name="filepath" readonly value="{{old('filepath',$post->image)}}" >
                              </div>
                              <img id="holder" style="margin-top:15px;max-height:100px; width: 100%" src="{{ $post->image }}">
