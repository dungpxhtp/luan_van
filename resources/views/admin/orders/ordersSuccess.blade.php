    ...
    <div class="container">
            <ol class="breadcrumb">
                <li class="breadcrumb-item breadcrumb-customer"><i class="fas fa-tachometer-alt"></i>Danh Sách Đơn Hàng </li>
                 <li class="breadcrumb-item active">Danh Sách Đơn Hàng Đã Giao Thành Công</li>
...
<nav aria-label="Page breadcrumb" class="my-3">
    <div class="container">
            <ol class="breadcrumb">
                <li class="breadcrumb-item breadcrumb-customer"><i class="fas fa-tachometer-alt"></i>Quản Lý Số Serinumber Của Sản Phẩm </li>
    ...
    <div class="row">
        <div class="col-md-12">
                <div class="table-responsive-sm">
                    <table class="table table-striped" id="table_serinumber">
                        <thead>
                          <tr>
                            <th scope="col">#</th>
                            <th scope="col">Mã Sản Phẩm</th>
                            <th scope="col">Số Serinumber sản phẩm bán</th>
                            <th scope="col">Thời Gian Và Tên Nhân Viên</th>
        ...
        <script>// load table
            $(document).ready(function(){
                ...
                $('#table_index').DataTable({
                    ...
                    ajax: '{{ Route('fetch_success_order') }}',
                    columns:[
                ...
                $('#table_serinumber').DataTable({
                    ...
                    columns:[
                        ...
                        {data:'timexacnhan',name:'timexacnhan'},
