        ...
        <div class="owl-carousel">
            ...
            <div>
                <div class="card" style="min-height: 480px">
                 <a href="{{Route('productDetail',['slug'=>$item->slug])}}">   <img class="card-img-top owl-lazy" src="{{ $item->image }}" data-src="{{ $item->image }}" alt="{{ $item->slug }}" width="170px;max-height:180px;"> </a>
