            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center ">
                        <h3 class="title-product text-uppercase">
                            <span class="span-title">{{ $brandShow->name }}</span>
                        </h3>
                    </div>
                </div>
                <div class="row my-3">
                ...
                @if (count($products)>0)
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <select class="custom-select" id="input-filter">
                                  ...
                                  <option value="1" data-url="{{ $brandShow->slug }}">Giá Thấp Đến Cao</option>
                                  <option value="2" data-url="{{ $brandShow->slug }}">Giá Từ Cao Xuống Thấp</option>
                                </select>
                              </div>
                        </div>
                    </div>
                    ...
                    <div id="pagination_show">
                        @includeIf('user.layout.brands-show-pagination')
                    </div>
                </div>
                @else
                <div class="row">
