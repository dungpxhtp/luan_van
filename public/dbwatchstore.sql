...
--
-- Host: localhost:3306
-- Generation Time: Jul 27, 2020 at 12:30 PM
...
CREATE TABLE `exportorders` (
  ...
  `fullName` varchar(255) NOT NULL,
  `phoneOder` varchar(255) NOT NULL,
  `totalOrder` varchar(255) NOT NULL,
  `Address` varchar(255) NOT NULL,
  `fullNameAdmin` varchar(255) NOT NULL DEFAULT '',
  `exportDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `payments` tinyint(1) NOT NULL,
  `status` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Danh Sách Đơn Hàng Xuất ';
...
CREATE TABLE `exportproducts` (
  ...
  `id_exportOrders` int(11) UNSIGNED NOT NULL
...
INSERT INTO `orders` (`id`, `id_users`, `codeOder`, `fullName`, `phoneOder`, `TotalOrder`, `Address`, `notes`, `Payments`, `status`, `created_at`, `updated_by`, `updated_at`) VALUES
(1, 15, '12343543', 'Phạm Minh Thiện', '01656581777', '44000', 'Phường 4 Quận 8', '', '1', 2, '2020-07-01 14:16:59', '1', '2020-07-09 09:13:28'),
(2, 13, '123123123', 'Tiên', '01656581777', '15', 'Phường 4 Quận 8', '', '1', 2, '2020-07-05 14:16:59', NULL, '2020-07-04 09:40:37'),
(3, 13, '123123123', 'Ngân', '01656581777', '20000', 'Phường 4 Quận 8', '', '1', 2, '2020-07-05 14:16:59', '1', '2020-07-08 13:37:22'),
(4, 16, 'FB2661526934088970-1594080311', 'Đồng hồ Nữ Casio LTP-V001SG-9BUDF', '0352113737', '40000000', 'tân an', 'ádasdasd', '1', 1, '2020-07-23 14:15:16', NULL, NULL),
(5, 16, 'FB2661526934088970-1242640801', 'thien', '0352113737', '40000000', 'tân an', 'ádasdsad', '1', 1, '2020-07-23 14:15:51', NULL, NULL),
(6, 16, 'FB2661526934088970-1957429144', 'abc', '0352113737', '160000000', 'tân an', 'ádsadasd', '1', 2, '2020-07-23 14:16:50', '1', '2020-07-23 15:24:20'),
(7, 16, 'FB2661526934088970-1864129127', 'abc', '0352113737', '26426246', 'tân an', 'ádasdsad', '1', 1, '2020-07-23 14:19:58', '1', '2020-07-23 15:21:48'),
(8, 16, 'FB2661526934088970-541478499', 'Đồng hồ Nữ Casio LTP-V001SG-9BUDF', '0352113737', '20000000', 'tân an', 'ádsadsad', '1', 2, '2020-07-23 14:21:18', '1', NULL),
(9, 16, 'FB2661526934088970-749233543', 'Phạm Minh Thiện', '0352113737', '20000000', 'ádasdsad', 'sadsadsadsad', '1', 1, '2020-07-23 15:36:51', NULL, NULL),
(10, 16, 'FB2661526934088970-1071747664', 'Đồng hồ Nữ Casio LTP-V001SG-9BUDF', '0352113737', '20000000', 'tân an', 'ádsadsad', '1', 1, '2020-07-23 15:38:44', NULL, NULL),
(13, 14, 'W1526558535-488478403', 'Phạm Minh Thiện', '0352113737', '60000000', 'tân an', '112312312', '1', 1, '2020-07-27 05:27:21', NULL, NULL),
(24, 14, 'W1526558535-609553186', 'Phạm Minh Thiện', '0352113737', '20000000', 'tân an', 'Thanh Toán Online', '2', 1, '2020-07-27 05:49:22', NULL, NULL),
(25, 14, 'W1526558535-1943799667', 'Phạm Minh Thiện', '0352113737', '20000000', 'tân an', 'ádasd', '1', 1, '2020-07-27 05:51:20', NULL, NULL),
(26, 14, 'W1526558535-114024181', 'Đồng hồ Nữ Casio LTP-V001SG-9BUDF', '0352113737', '20000000', 'tân an', 'thanh toasbn online', '2', 1, '2020-07-27 05:51:40', NULL, NULL),
(27, 14, 'W1526558535-991522234', 'sadsad', '0356581777', '20000000', 'tân an', 'ádasd', '1', 1, '2020-07-27 06:01:29', NULL, NULL),
(28, 16, 'FB2661526934088970-1373860574', 'Phạm Minh Thiện', '0352113737', '60000000', 'quận 8', 'Thanh Toán Online', '2', 1, '2020-07-27 06:06:25', NULL, NULL),
(29, 16, 'FB2661526934088970-2047129027', 'Phạm Minh Thiện', '0352113737', '20000000', 'quận 8', '123123', '2', 1, '2020-07-27 06:07:06', NULL, NULL),
(30, 16, 'FB2661526934088970-23719309', 'Tên mới', '0352113737', '60000000', 'quận 8', 'Thanh Toán Đơn Hàng', '2', 2, '2020-07-27 06:18:58', NULL, NULL);
...
(5, 8, 1, 2000, 2, 2000),
(6, 8, 3, 2000, 4, 4000),
(7, 1, 6, 20000000, 8, 160000000),
(8, 8, 7, 13213123, 2, 26426246),
(9, 1, 8, 20000000, 1, 20000000),
(10, 1, 9, 20000000, 1, 20000000),
(11, 1, 10, 20000000, 1, 20000000),
(14, 1, 13, 20000000, 3, 60000000),
(25, 1, 24, 20000000, 1, 20000000),
(26, 1, 25, 20000000, 1, 20000000),
(27, 1, 26, 20000000, 1, 20000000),
(28, 1, 27, 20000000, 1, 20000000),
(29, 1, 28, 20000000, 3, 60000000),
(30, 1, 29, 20000000, 1, 20000000),
(31, 1, 30, 20000000, 3, 60000000);
...
--
-- Indexes for table `exportorders`
--
ALTER TABLE `exportorders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_exportOrders_admin` (`id_admin`);
...
ALTER TABLE `exportproducts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_exportproducts_exportproducts` (`id_exportOrders`);
...
--
-- Constraints for table `exportorders`
--
ALTER TABLE `exportorders`
  ADD CONSTRAINT `FK_exportOrders_admin` FOREIGN KEY (`id_admin`) REFERENCES `admin` (`id`);

--
-- Constraints for table `exportproducts`
--
ALTER TABLE `exportproducts`
  ADD CONSTRAINT `FK_exportproducts_exportproducts` FOREIGN KEY (`id_exportOrders`) REFERENCES `exportproducts` (`id`);
